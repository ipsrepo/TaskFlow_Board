...
const KanbanBoard = () => {
  ...
  return (
      <div className="page-container flex min-h-[calc(100vh-9rem)] flex-col">
        <div className="mb-5 flex flex-col gap-4 border-b border-line pb-5 xl:flex-row xl:items-center xl:justify-between">
        ...
        {statusBoards.length === 0 ? (
            ...
            <div className="min-h-0 flex-1 overflow-x-auto pb-3 custom-scrollbar">
              ...
              >
                <div className="grid min-h-full min-w-max grid-flow-col auto-cols-[minmax(292px,1fr)] gap-4 xl:min-w-full xl:grid-flow-row xl:grid-cols-3 2xl:grid-cols-4">
