                  ...
                  <>
                    ...
                    <div className="rounded-2xl border border-line bg-surface p-4">
                      <div className="mb-3 flex items-center justify-between gap-3">
                        ...
                        <span className="rounded-full bg-primary-50 px-2 py-1 text-xs font-semibold text-primary">
      {formValues.members.length} members
    </span>
                      </div>

                      {formValues.members.length > 0 ? (
                          <div className="max-h-60 overflow-y-auto rounded-xl border border-line custom-scrollbar">
              ...
              <span className="block truncate text-xs text-muted">
                ...
                {candidate.role}
                          ...
                          <div className="rounded-xl border border-dashed border-line bg-surfaceSubtle px-4 py-7 text-center">
