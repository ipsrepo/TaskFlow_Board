        ...
        <div className="page-container space-y-6">
            ...
            {isLoading ? (
                ...
                <Card className="overflow-hidden p-0">
                    <div
                        className="hidden grid-cols-[minmax(0,1fr)_150px_150px_120px] gap-5 border-b border-line bg-surfaceSubtle px-5 py-3 text-xs font-semibold uppercase tracking-[0.06em] text-muted lg:grid">
                        <span>Task</span>
