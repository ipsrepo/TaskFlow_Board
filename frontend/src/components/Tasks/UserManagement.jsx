      ...
      <div className="page-container space-y-6">
        <header className="flex flex-col gap-5 border-b border-line pb-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary">
          ...
          <div className="inline-flex w-fit items-center gap-2 rounded-xl border border-line bg-surface px-3 py-2 text-xs font-medium text-muted shadow-card">
        ...
        {isLoading ? (
            ...
            <Card className="overflow-hidden border border-line p-0">
              <div className="hidden grid-cols-[minmax(0,1fr)_130px_130px_48px] gap-5 border-b border-line bg-surfaceSubtle px-5 py-3 text-[11px] font-bold uppercase tracking-[0.08em] text-muted lg:grid">
                <span>User</span>
                <span>Role</span>
                <span>Status</span>
                <span />
                        ...
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center gap-2">
                              ...
                              {isCurrentUser && (
                                  <span className="rounded-md bg-primary-50 px-1.5 py-0.5 text-[10px] font-semibold text-primary">
                            YOU
                          </span>
                              )}
                            </div>
