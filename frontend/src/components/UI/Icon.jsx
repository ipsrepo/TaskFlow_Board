const paths = {
  ...
  tasks: <><path d="M9 6h11M9 12h11M9 18h11" /><path d="m4 6 1.5 1.5L7.5 5M4 12l1.5 1.5L7.5 11M4 18l1.5 1.5L7.5 17" /></>,
  ...
  flag: <><path d="M5 22V4" /><path d="M5 5h12l-2 4 2 4H5" /></>,
  clock: <><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></>,
  message: <><path d="M21 11.5a8.38 8.38 0 0 1-9 8.5 9.5 9.5 0 0 1-4.5-1L3 20l1.2-4.1A8.5 8.5 0 1 1 21 11.5Z" /></>,
  ...
  inbox: <><path d="M4 4h16v12h-5l-3 3-3-3H4Z" /><path d="M4 12h4l1 2h6l1-2h4" /></>,
  help: <><circle cx="12" cy="12" r="9" /><path d="M9.5 9a2.5 2.5 0 1 1 4.25 1.8c-.9.85-1.75 1.4-1.75 2.7M12 17h.01" /></>,
  rocket: <><path d="M14.5 4.5c2.7-2.2 5.5-2 5.5-2s.2 2.8-2 5.5l-4.5 4.5-4.5-4.5Z" /><path d="m9 9-4 1-2 4 4 1M15 15l-1 4-4 2-1-4M8 16l-3 3" /></>,
