...
const Dropdown = ({trigger, items = [], className = '', align = 'right'}) => {
    ...
    return (
        <div ref={containerRef} className={`relative ${className}`}>
            ...
            {isOpen && (
                <div
                    className={`absolute z-40 mt-2 w-52 overflow-hidden rounded-xl border border-line bg-white p-1 shadow-card-hover animate-scale-in ${align === 'left' ? 'left-0' : 'right-0'}`}>
