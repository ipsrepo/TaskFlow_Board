    ...
    return (
        <div>
            <div className="mb-8">
                ...
                <h1 className="mt-2 text-[32px] font-bold leading-tight tracking-[-0.05em] text-secondary sm:text-[36px]">Sign
                    in to TaskBoard</h1>
                <p className="mt-3 text-sm leading-6 text-muted">Access your projects, priorities, and team activity
                    from one focused workspace.</p>
            </div>
