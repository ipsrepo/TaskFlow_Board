    ...
    return (
        <div>
            <div className="mb-7">
                ...
                <h1 className="mt-2 text-[32px] font-bold leading-tight tracking-[-0.05em] text-secondary sm:text-[36px]">Get
                    started with TaskBoard</h1>
                <p className="mt-3 text-sm leading-6 text-muted">Create an account and bring every project, task, and
                    conversation into one place.</p>
            </div>
